    ...
    <section className="relative w-full h-screen overflow-hidden bg-black dark:bg-zinc-900">
      <AnimatePresence mode="wait">
        ...
        >
          ...
          {/* Content Loader or Slide Content */}
          {isImageLoading ? (
            ...
            <div className="relative z-10 max-w-4xl px-6 md:px-10">
              <h1 className="mb-4 text-4xl md:text-6xl font-extrabold text-white drop-shadow-xl dark:text-white">
                {bannerSlides[currentSlide].title}
              </h1>
              <p className="mb-8 text-lg md:text-2xl text-gray-200 dark:text-gray-300">
                {bannerSlides[currentSlide].subtitle}
              </p>
              <button className="rounded-full bg-gradient-to-r from-blue-500 to-cyan-400 px-8 py-3 text-lg font-semibold text-white shadow-md hover:from-blue-600 hover:to-cyan-500 transition">
